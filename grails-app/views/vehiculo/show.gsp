...
<html>
    ...
    <body>
        ...
        <div id="show-vehiculo" class="content scaffold-show" role="main">
            ...
            <f:display bean="vehiculo" />
            <g:form resource="${this.vehiculo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vehiculo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
